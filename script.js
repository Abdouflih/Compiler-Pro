var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
  ...
  var users = {
    phineas: {
      ...
      avatar: 'https://i.ibb.co/1d0rf9F/Einstein-Pfp.png'
    },
    paragon: {
      username: 'Compiler Pro',
      nameColor: 'hsl(212, 51%, 59%)',
      bot: true,
      avatar: 'https://cdn.discordapp.com/avatars/949027139859124245/453897864139ac926ee04634ea4b56c6.png?size=1024'
    }
  };
  ...
  var channelData = [{
    ...
    messages: [{
      ...
      embedData: {
        ...
        fields: [{
          name: '-> Compiler Pro',
          value: "Compiler Pro Is A Discord Bot Used To Compile Your Code Inside Of Discord."
        }, {
          name: '-> Commands',
          value: 'For This Bot, We Have Few commands To Order Your Wish. All of them Are down Below!'
        }, {
          name: '--> Compile',
          value: 'This Command Is Used To Compile A Code Given By The User'
        }, {
          name: '--> Languages',
          value: 'This Command Gives You A list That Contains Our Availble Languages For Now. To Check The List Of Languages Used In Compile Command Use: -help languages'
        }, {
          name: '--> Support',
          value: "You Can Use This Command To Get The Link Of Our Discord's Invite Link. Feel Free To Join And ask us For Anything Anytime!"
        }, {
          name: '--> News',
          value: 'You Can Use This Command To Check The Latest Updates Of Our Bot. Sometimes Well Put Upcoming Updates Here too!'
        }]
      }
    }]
  }, {
